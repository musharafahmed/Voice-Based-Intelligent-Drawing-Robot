...
//test="Desktop\067-XY-Plotter-Drawing-Robot\.SVG IMAGES\sun.svg";
    gcode = loadStrings("talha");
...
/*void fileSelected(File selection) {
  if (selection == null) {
    ...
    //println("User selected " + selection.getAbsolutePath());
//test="Desktop\067-XY-Plotter-Drawing-Robot\.SVG IMAGES\sun.svg";
    gcode = loadStrings("C:/Users/ZAHRA/Desktop/067-XY-Plotter-Drawing-Robot/.SVG%20IMAGES/sun.svg");
    if (gcode == null) return;
    streaming = true;
    stream();
  }
